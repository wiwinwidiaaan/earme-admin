...
<template>
  <div>
    <PageHeader
      title="Kosakata"
      description="Semua entri kamus beserta video peragaannya."
    >
      <template #actions>
        <select
        ...
        <tbody>
          <tr v-for="e in entries" :key="e.id">
            ...
            <td class="row-actions">
              ...
              <button class="btn btn-danger" @click="confirmDelete(e.id)">
                Hapus
              </button>
            </td>
          </tr>
    ...
    >
      <form class="form-grid" @submit.prevent="submitForm">
        ...
        <div class="field">
          <label
            >Video
            {{ editingId ? "(kosongkan jika tidak diganti)" : "" }}</label
          >
          <input
            type="file"
        ...
        <div class="field">
          ...
          <input
            ...
            accept="image/*"
            class="input"
            @change="thumbFile = $event.target.files[0]"
          />
        </div>
        <div class="field">

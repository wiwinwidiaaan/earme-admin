...
<template>
  <div>
    <PageHeader
      title="Artikel"
      description="Konten bacaan seputar bahasa isyarat."
    >
      <template #actions>
        ...
        <tbody>
          <tr v-for="a in articles" :key="a.id">
            ...
            <td class="row-actions">
              ...
              <button class="btn btn-danger" @click="confirmDelete(a.id)">
                Hapus
              </button>
            </td>
          </tr>
    ...
    >
      <form class="form-grid" @submit.prevent="submitForm">
        ...
        <div class="field">
          <label
            >Tanggal Terbit
            <span class="hint">(opsional, default sekarang)</span></label
          >
